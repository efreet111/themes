		...
		<div class="col-md-8">
			...
			<!--Menu Veritical  -->
					...
					<!-- Inicio Lista de Paciente Menu Vertical -->
							<?php include "front1_Listapaciente.php";?>
					<!-- Fin Lista de Paciente  -->

					<!-- Inicio Paciente Citado Menu Vertical -->
							<?php include "front2_Pacientecitado.php";?>
					<!-- Fin Paciente Citado Menu Vertical  -->
					
					<!-- Inicio Ingreso de Paciente Menu Vertical -->
							<?php include "front3_Ingresopaciente.php";?>
					<!-- Fin Ingreso de Paciente  Menu Vertical  -->

					<!-- Inicio Servicios Menu Vertical -->
							<?php include "front5_Informacion de servicios.php";?>
					<!-- Fin Servicios Menu Vertical  -->
