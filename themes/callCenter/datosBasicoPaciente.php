			...
			<h3>Datos basicos del paciente</h3>
			...
			<div class="row">
				...
				<div class="col-xs-2">
					   <label for="edad">Num Historia</label>
					  <input type="Number" name="edad" id="edad" class="form-control input-sm">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4">
					  ...
					  <select class="form-control" id="pais" disabled>
						<option value="">--Seleccionar País--</option>
						<option selected="selected" value="Ven">Venezuela</option>
						<option value="Pan">Panama</option>
						<option value="Col">Colombia</option>
						<option value="Usa">Usa</option>
						<option value="Ecua">Ecuador</option>
